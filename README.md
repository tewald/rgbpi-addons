...
This is a **collection of unofficial scripts for [RGBPiOS](https://www.rgb-pi.com/#os)** allowing you to quickly and easily **install emulators, ports and libretrocores** that haven't been included in RGBPi for one reason or another. These scripts can be considered experimental at best. The idea to create this came from [RetroPie-Extra](https://github.com/Exarkuniv/RetroPie-Extra)
